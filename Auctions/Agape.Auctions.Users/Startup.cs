...
namespace Agape.Auctions.Users
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            //services.AddSingleton<ICosmosRepository<AgapeModel.User, AgapeModel.UserBase>>(InitializeCosmosRepositaryInstanceAsync(Configuration.GetSection("CosmosDb")).GetAwaiter().GetResult());
        }
        ...
        private static async Task<ICosmosRepository<AgapeModel.User, AgapeModel.UserBase>> InitializeCosmosRepositaryInstanceAsync(IConfigurationSection configurationSection)
        {
            ICosmosRepository<AgapeModel.User, AgapeModel.UserBase> cosmosRepository;
            ...
            cosmosRepository = new CosmosRepository<AgapeModel.User, AgapeModel.UserBase>(cosmosDbKey, options);
