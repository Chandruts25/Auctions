...
namespace Agape.Auctions.CarImage
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            //services.AddSingleton<ICosmosRepository<AgapeModel.Image, AgapeModel.Image>>(InitializeCosmosRepositaryInstanceAsync(Configuration.GetSection("CosmosDb")).GetAwaiter().GetResult());
        }
        ...
        private static async Task<ICosmosRepository<AgapeModel.Image, AgapeModel.Image>> InitializeCosmosRepositaryInstanceAsync(IConfigurationSection configurationSection)
        {
            ICosmosRepository<AgapeModel.Image, AgapeModel.Image> cosmosRepository;
            ...
            cosmosRepository = new CosmosRepository<AgapeModel.Image, AgapeModel.Image>(cosmosDbKey, options);
